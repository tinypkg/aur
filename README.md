...
- **[cc-mesh-bin](https://aur.archlinux.org/packages/cc-mesh-bin)** - Claude Code / Codex 本地 Tauri 桌面代理网关，支持 Anthropic Messages ↔ OpenAI 兼容协议转换、模型映射和多端点轮换/熔断 ([主页](https://github.com/VkRainB/ccMesh))
...
- **[ediary-bin](https://aur.archlinux.org/packages/ediary-bin)** - eDiary 是一款免费的、久经考验的日记软件（[官网](https://www.haoxg.net)）
...
- **[lody-bin](https://aur.archlinux.org/packages/lody-bin)** - 并行运行 AI 编程代理的团队工作区，隔离 Git worktrees、实时 diff 审查与 GitHub 集成（[官网](https://lody.ai/home)）
...
- **[vlaina-bin](https://aur.archlinux.org/packages/vlaina-bin)** - A purest sanctuary,for your deepest thoughts. ([主页](https://github.com/vladelaina/vlaina))
